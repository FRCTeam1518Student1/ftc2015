...
//=================== Top Limit Switch =====================			
        ...
        if(LTLimit.isPressed()) {
            ...
            //Keep moving upwards if the Top Limit Switch is NOT pressed
            CServoLiftPosition += 0;
        }
...
//=================== Bottom Limit Switch =====================		
        ...
        // Tell the lift servo to stop if the Bottom Limit Switch is pressed.
        if(LBLimit.isPressed()) {
            //Stop the lift motor if the Bottom Limit Switch is pressed.
            CServoLiftPosition = 0.5;
        } else {
            //Keep moving downwards if the Bottom Limit Switch is NOT pressed
            CServoLiftPosition -= 0;
        }
